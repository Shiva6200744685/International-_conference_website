            ...
            <div className="flex flex-col md:grid grid-cols-12 text-gray-50">
              <div className="flex md:contents">
                ...
                <div className="bg-red-500 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
                  <h3 className="font-semibold text-lg mb-1"><span className="font-medium text-xl underline">Last date</span> of submission of <span className="text-2xl font-bold">abstract</span></h3>
              ...
              <div className="flex md:contents">
                ...
                <div className="bg-red-500 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
                  <h3 className="font-semibold text-lg mb-1"><span className="font-medium text-xl underline">Last date</span> for submission of <span className="text-2xl font-bold">Full Paper</span></h3>
              ...
              <div className="flex md:contents">
                ...
                <div className="bg-green-500 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
                  ...
                  <span className="font-medium text-xl underline">Notification</span> of acceptance of <span className="text-2xl font-bold">Full paper</span>
                  </h3>
                  <p className="leading-tight text-justify">
                    25 December 2021
                  </p>
              ...
              <div className="flex md:contents">
                ...
                <div className="bg-gray-300 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
                  <h3 className="font-semibold text-lg mb-1 text-gray-400">
                    International Conference on <span className="text-2xl font-bold">Computer Science</span>
                  </h3>
